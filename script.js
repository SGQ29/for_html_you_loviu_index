...
function revelarTarjeta(tarjeta) {
    ...
    if (tarjeta.classList.contains("revelada"))
        return;
...
function escribirMensaje(){
    ...
    if(indiceMensaje < mensajeFinal.length){
        ...
        mensajeFinal.charAt(indiceMensaje);
...
//===============================================
// CUANDO APARECE LA ESCENA 10
// COMIENZA UNA LLUVIA MÁS INTENSA
//===============================================

const escena10 =
document.getElementById("escena10");
...
//===============================================
// MENSAJE DE CONSOLA ❤️
//===============================================

console.log(
"Para la niña más bonita del mundo ❤️"
);
